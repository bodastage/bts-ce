...
def parse_and_import_zte_2g(parent_dag_name, child_dag_name, start_date, schedule_interval):
    ...
    parse_zte_2g_cm_files = BashOperator(
      ...
      bash_command='java -jar /mediation/bin/boda-bulkcmparser.jar /mediation/data/cm/zte/raw/bulkcm_gsm /mediation/data/cm/zte/parsed/bulkcm_gsm /mediation/conf/cm/zte_cm_2g_blkcm_parser.cfg',
      dag=dag)
