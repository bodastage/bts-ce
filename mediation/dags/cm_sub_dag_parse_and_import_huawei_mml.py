...
def parse_and_import_huawei_mml(parent_dag_name, child_dag_name, start_date, schedule_interval):
    ...
    parse_huawei_mml_cm_files = BashOperator(
    ...
    t_run_huawei_mml_insert_queries = BashOperator(
    ...
    def clear_huawei_mml_cm_tables():
        pass

    t50 = PythonOperator(
        task_id='clear_huawei_mml_cm_tables',
        python_callable=clear_huawei_mml_cm_tables,
        dag=dag)
